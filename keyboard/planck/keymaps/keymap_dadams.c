...
[_LW] = { /* LOWER */
  ...
  {KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
  {DF(_SC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DF(_SC), KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
[_SC] = { /* STARCRAFT */
...
[_SCCAM] = { /* STARCRAFT RECALL CAM */
  ...
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_F7), KC_F5,       KC_F6,       KC_F7,       KC_F8,       LSFT(KC_F5),  KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_F8), LSFT(KC_F6), KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,      KC_TRNS},
  {M(1),    M(2),    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,     LSFT(KC_F7), LSFT(KC_F8), KC_TRNS,     KC_TRNS,      KC_TRNS}
},
[_SCSETCAM] = { /* STARCRAFT SET CAM */
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_TRNS,     KC_TRNS,          KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_F5),       LCTL(KC_F6),       LCTL(KC_F7),       LCTL(KC_F8), LCTL(LSFT(KC_F5)),KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(LSFT(KC_F6)), KC_TRNS,           KC_TRNS,           KC_TRNS,     KC_TRNS,          KC_TRNS},
  {M(1),    M(2),    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,           LCTL(LSFT(KC_F7)), LCTL(LSFT(KC_F8)), KC_TRNS,     KC_TRNS,          KC_TRNS}
}
};
